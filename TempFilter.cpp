...
int main()
{
    ...
    double q = 0.0001;  // process noise variance (assumed to be very accurate)
    ...
    double measurements[10] = {49.986, 49.963, 50.09, 50.001, 50.018, 50.05, 49.938, 49.858, 49.965, 50.144};
    double truths[10] = {50.005, 49.994, 49.993, 50.001, 50.006, 49.998, 50.021, 50.005, 50, 49.997};
