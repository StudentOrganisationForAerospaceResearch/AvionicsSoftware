...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, IMU_CS_Pin|VENT_VALVE_Pin|INJECTION_VALVE_Pin|SD1_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED2_Pin|FAN_CTRL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IMU_CS_Pin VENT_VALVE_Pin INJECTION_VALVE_Pin SD1_CS_Pin */
  GPIO_InitStruct.Pin = IMU_CS_Pin|VENT_VALVE_Pin|INJECTION_VALVE_Pin|SD1_CS_Pin;
  ...
  /*Configure GPIO pins : LED2_Pin FAN_CTRL_Pin */
  GPIO_InitStruct.Pin = LED2_Pin|FAN_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
