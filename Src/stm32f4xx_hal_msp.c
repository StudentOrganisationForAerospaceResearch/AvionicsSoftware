...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PB1     ------> ADC2_IN9 
    */
    GPIO_InitStruct.Pin = PROPULSION_3_VALVE_PRESSURE_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PROPULSION_3_VALVE_PRESSURE_ADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9 
    */
    HAL_GPIO_DeInit(PROPULSION_3_VALVE_PRESSURE_ADC_GPIO_Port, PROPULSION_3_VALVE_PRESSURE_ADC_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA 
    */
    HAL_GPIO_DeInit(GPIOB, EEPROM_I2C_SCL_Pin|EEPROM_I2C_SDA_Pin);
