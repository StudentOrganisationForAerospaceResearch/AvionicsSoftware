...
bool W25qxx_Init(void)
{
...
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("w25qxx Chip: w25q512\r\n");
#endif
		break;
	case 0x19: // 	w25q256
		w25qxx.ID = W25Q256;
...
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("w25qxx Chip: w25q256\r\n");
#endif
		break;
	case 0x18: // 	w25q128
		w25qxx.ID = W25Q128;
...
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("w25qxx Chip: w25q128\r\n");
#endif
		break;
	case 0x17: //	w25q64
		w25qxx.ID = W25Q64;
	...
	case 0x11: //	w25q10
		...
		w25qxx.BlockCount = 2;
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("w25qxx Chip: w25q10\r\n");
#endif
		break;
	default:
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("w25qxx Unknown ID\r\n");
#endif
		w25qxx.Lock = 0;
		return false;
	}
...
#if (_W25QXX_DEBUG == 1)
	SOAR_PRINT("w25qxx Page Size: %d Bytes\r\n", w25qxx.PageSize);
	SOAR_PRINT("w25qxx Page Count: %d\r\n", w25qxx.PageCount);
	SOAR_PRINT("w25qxx Sector Size: %d Bytes\r\n", w25qxx.SectorSize);
	SOAR_PRINT("w25qxx Sector Count: %d\r\n", w25qxx.SectorCount);
	SOAR_PRINT("w25qxx Block Size: %d Bytes\r\n", w25qxx.BlockSize);
	SOAR_PRINT("w25qxx Block Count: %d\r\n", w25qxx.BlockCount);
	SOAR_PRINT("w25qxx Capacity: %d KiloBytes\r\n", w25qxx.CapacityInKiloByte);
	SOAR_PRINT("w25qxx Init Done\r\n");
#endif
	w25qxx.Lock = 0;
	return true;
}
...
void W25qxx_EraseChip(void)
{
	...
	SOAR_PRINT("w25qxx EraseChip Begin...\r\n");
#endif
	W25qxx_WriteEnable();
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_RESET);
	W25qxx_Spi(0xC7);
...
#if (_W25QXX_DEBUG == 1)
	uint32_t StartTime = HAL_GetTick();
	SOAR_PRINT("w25qxx EraseSector %d Begin...\r\n", SectorAddr);
#endif
	W25qxx_WaitForWriteEnd();
...
void W25qxx_EraseBlock(uint32_t BlockAddr)
{
	...
	w25qxx.Lock = 1;
#if (_W25QXX_DEBUG == 1)
	SOAR_PRINT("w25qxx EraseBlock %d Begin...\r\n", BlockAddr);
	W25qxx_Delay(100);
	uint32_t StartTime = HAL_GetTick();
#endif
	W25qxx_WaitForWriteEnd();
...
#if (_W25QXX_DEBUG == 1)
	SOAR_PRINT("---w25qxx WriteSector Done\r\n");
	W25qxx_Delay(100);
#endif
}
//###################################################################################################################
void W25qxx_WriteBlock(uint8_t *pBuffer, uint32_t Block_Address, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_BlockSize)
{
	...
	{
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("---w25qxx WriteBlock Faild!\r\n");
		W25qxx_Delay(100);
#endif
		return;
	}
...
#if (_W25QXX_DEBUG == 1)
	SOAR_PRINT("---w25qxx WriteBlock Done\r\n");
	W25qxx_Delay(100);
#endif
}
//###################################################################################################################
...
#if (_W25QXX_DEBUG == 1)
	uint32_t StartTime = HAL_GetTick();
	SOAR_PRINT("w25qxx ReadByte at address %d begin...\r\n", Bytes_Address);
#endif
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_RESET);
...
void W25qxx_ReadBytes(uint8_t *pBuffer, uint32_t ReadAddr, uint32_t NumByteToRead)
{
	...
	SOAR_PRINT("\r\n");
	SOAR_PRINT("w25qxx ReadBytes done after %d ms\r\n", StartTime);
	W25qxx_Delay(100);
#endif
	W25qxx_Delay(1);
	w25qxx.Lock = 0;
...
void W25qxx_ReadPage(uint8_t *pBuffer, uint32_t Page_Address, uint32_t OffsetInByte, uint32_t NumByteToRead_up_to_PageSize)
{
	...
	SOAR_PRINT("\r\n");
	SOAR_PRINT("w25qxx ReadPage done after %d ms\r\n", StartTime);
	W25qxx_Delay(100);
#endif
	W25qxx_Delay(1);
	w25qxx.Lock = 0;
...
void W25qxx_ReadSector(uint8_t *pBuffer, uint32_t Sector_Address, uint32_t OffsetInByte, uint32_t NumByteToRead_up_to_SectorSize)
{
	...
	{
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("---w25qxx ReadSector Faild!\r\n");
		W25qxx_Delay(100);
#endif
		return;
	}
...
#if (_W25QXX_DEBUG == 1)
	SOAR_PRINT("---w25qxx ReadSector Done\r\n");
	W25qxx_Delay(100);
#endif
}
//###################################################################################################################
void W25qxx_ReadBlock(uint8_t *pBuffer, uint32_t Block_Address, uint32_t OffsetInByte, uint32_t NumByteToRead_up_to_BlockSize)
{
	...
	{
#if (_W25QXX_DEBUG == 1)
		SOAR_PRINT("w25qxx ReadBlock Faild!\r\n");
		W25qxx_Delay(100);
#endif
		return;
	}
...
#if (_W25QXX_DEBUG == 1)
	SOAR_PRINT("---w25qxx ReadBlock Done\r\n");
	W25qxx_Delay(100);
#endif
}
//###################################################################################################################
