...
constexpr uint32_t BURN_TIMER_PERIOD_MS =
    2 * 1000;  // LAUNCH -> BURN Timer is      2 seconds (LAUNCH for 2 seconds after confirmation)
...
constexpr uint32_t RECOVERY_TIMER_PERIOD_MS =
    10 * 1000;  // DESCENT -> RECOVERY Timer is 10 seconds(DESCENT for 10 seconds) -- Vents Open
